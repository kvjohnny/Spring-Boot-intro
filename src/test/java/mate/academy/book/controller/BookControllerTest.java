...
public class BookControllerTest {
    ...
    void getAll_GivenBooks_ReturnsAllBooks() throws Exception {
        List<BookDto> expected = TestUtil.createListOfBookDto();
        MvcResult result = mockMvc.perform(
                        get("/books")
                                .contentType(MediaType.APPLICATION_JSON)
                )
    ...
    void updateBook_WithValidBookId_ReturnsUpdatedBook() throws Exception {
        BookDto expected = TestUtil.createUpdatedBookResponseDto();
        CreateBookRequestDto updatedBookRequestDto = TestUtil.createUpdatedBookRequestDto();
